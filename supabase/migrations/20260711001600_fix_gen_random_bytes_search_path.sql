-- ============================================================
-- Migration 016: Fix gen_random_bytes search_path issue
-- ============================================================
--
-- BUG FIX:
--   generate_store_invite_code uses SET search_path = '' which
--   prevents the function from finding gen_random_bytes() in
--   the pgcrypto extension. In Supabase, pgcrypto is installed
--   in the "extensions" schema, so we must schema-qualify the
--   call as extensions.gen_random_bytes().
--
--   This migration re-creates the function with the fix.
--
-- ============================================================
...
BEGIN
    ...
    -- FIX: Schema-qualify extensions.gen_random_bytes for SET search_path = ''
...
-- ============================================================
-- Permissions (re-apply after function replacement)
-- ============================================================
