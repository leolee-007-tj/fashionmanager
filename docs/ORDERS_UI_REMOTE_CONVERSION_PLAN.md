...
| 2 | 3-8A.10-B | Remote UI post-bugfix smoke (recommended) | 🔜 BLOCKER-FIX-3 (Dashboard/product list datasource mismatch) 완료 (2026-07-27). BLOCKER-FIX-4 (Product import year/month visibility guard) 완료 (2026-07-28). BLOCKER-FIX-5 (Product CRUD identity/delete/metrics integrity) 완료 (2026-07-29). Product UI blocker 5건 모두 해결 후 재개 |
